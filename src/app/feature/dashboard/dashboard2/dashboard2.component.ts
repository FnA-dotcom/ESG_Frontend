...
export class Dashboard2Component implements OnInit {
  ...
  getCard1Counter(count) {
    ...
    const interval = setInterval(() => {
      if (this.card1Counter = count - 1) { clearInterval(interval) }
      this.card1Counter++;
    }, 100);
  ...
  periodChange(event) {
    ...
    if (this.currentYear === '2018') {
      ...
      this.chartOptions = {
        series: [
          {
            name: "",
            data: [490, 450, 400, 30, 200, 280, 450, 250,300, 380, 400, 150, 280, 490, 250, 365,]
    ...
    else if (this.currentYear === '2019') {
      this.chartOptions = {
        series: [
          {
            name: "",
            data: [450, 350, 300, 40, 100, 180, 350, 150, 200, 280, 300, 150, 180, 390, 150, 265,]
      ...
      this.chartOptions = {
        series: [
          {
            name: "",
            data: [460, 360, 300, 41, 110, 190, 360, 160, 210, 290, 310, 160, 190, 310, 160, 275,]
      ...
      this.chartOptions = {
        series: [
          {
            name: "",
            data: [481, 391, 391, 415, 191, 121, 391, 181, 251, 291, 321, 151, 191, 391, 161, 255,]
      ...
      this.chartOptions = {
        series: [
          {
            name: "",
            data: [150, 450, 322, 489, 173, 153, 367, 15, 500, 400, 300, 183, 193, 398, 167, 496,]
